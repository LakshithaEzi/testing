...
const ProfileCard = forwardRef((props, ref) => {
  ...
  return (
    <section ref={ref} id="profile-card">
      <div className="flex flex-col items-center p-4 lg:flex-row m-9">
        ...
        <div className="flex-1">
          <div className="space-y-4 text-center font-poppins lg:text-left">
            ...
            <p className="max-w-lg mx-auto text-gray-500 lg:mx-0">
              ...
              eager to take on challenges and seeking an opportunity as a
              trainee software engineer to apply and explore both current and
              emerging technologies in the field of Information Technology.
            </p>

            <div className="flex flex-wrap justify-center gap-3 mt-4 lg:justify-start">
              <a
                href="https://mega.nz/file/QxcCXZZY#zvaeg9ZFk_gLyttMjGk4h-_Q_tYcpOwT-lMUcdafEqE"
                download
        ...
        <div className="flex flex-row items-center mt-4 space-x-4 lg:flex-col lg:space-x-0 lg:space-y-4 lg:mt-0 lg:ml-6">
          ...
          <a
            href="https://www.instagram.com/lakshitha_ezi/"
            className="text-2xl text-green-700"
          >
            <FaInstagram />
          </a>
